  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section
        ...
        style={{
          backgroundImage: 'linear-gradient(rgba(31, 58, 86, 0.85), rgba(31, 58, 86, 0.85)), url(https://images.pexels.com/photos/3938023/pexels-photo-3938023.jpeg?auto=compress&cs=tinysrgb&w=1920)',
      ...
      >
        <div className="container mx-auto px-4 text-center text-white">
          <div className="inline-block p-6 bg-gold/20 rounded-full mb-8">
            <Package className="w-20 h-20 text-gold" />
          </div>
          <h1 className="text-5xl md:text-6xl font-bold mb-6">
            بنود التوريدات
          </h1>
          <p className="text-xl md:text-2xl mb-8 text-gray-200 max-w-3xl mx-auto leading-relaxed">
            توفير شامل لجميع أنواع التوريدات العمومية بأعلى معايير الجودة والموثوقية
          </p>
          <p className="text-lg text-gray-300 mb-12 max-w-2xl mx-auto">
            نحن نقدم حلولاً متكاملة للمؤسسات الحكومية والخاصة مع ضمان الالتزام بالمواصفات الدولية والأسعار التنافسية
          </p>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              {[
                'مواد البناء والحديد',
                'معدات المكاتب والأثاث',
                'المعدات الطبية والصيدلانية',
                'مستلزمات الصيانة',
                'المعدات الكهربائية',
                'المستلزمات الصحية والنظافة',
                'قطع الغيار الصناعية',
                'السلع الاستهلاكية',
                'المواد الكيميائية'
              ].map((service, index) => (
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 mb-8">
              احصل على عروض مخصصة لاحتياجاتك من التوريدات
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a
                href="tel:+201552222167"
